...
var _InlineResponse2001Data = _interopRequireDefault(require("./InlineResponse2001Data"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _InlineResponse2001Data["default"].constructFromObject(data['data']);
        }
      }
