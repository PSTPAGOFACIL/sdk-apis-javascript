...
var _InlineResponse2004Data = _interopRequireDefault(require("./InlineResponse2004Data"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _InlineResponse2004Data["default"].constructFromObject(data['data']);
        }
      }
