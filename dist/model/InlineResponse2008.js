...
var _InlineResponse2008Types = _interopRequireDefault(require("./InlineResponse2008Types"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('types')) {
          obj['types'] = _ApiClient["default"].convertToType(data['types'], [_InlineResponse2008Types["default"]]);
        }
      }
