...
var _DataLoginResponse = _interopRequireDefault(require("./DataLoginResponse"));
 ...
 * @version 2.1.0
 */
var LoginResponse = /*#__PURE__*/function () {
  /**
  ...
  _createClass(LoginResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _DataLoginResponse["default"].constructFromObject(data['data']);
        }
      }
